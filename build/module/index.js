...
var ReactTagInput = (function (_super) {
    ...
    ReactTagInput.prototype.render = function () {
        ...
        return (React.createElement("div", { className: classSelectors.wrapper },
            ...
            showInput &&
                React.createElement("input", { ref: this.inputRef, value: input, className: classSelectors.input, placeholder: placeholder || "Type and press enter", onChange: this.onInputChange, onKeyDown: this.onInputKeyDown, onBlur: this.customOnBlur })));
    };
